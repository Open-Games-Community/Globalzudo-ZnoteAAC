...
if ($render_page) {
	...
	<?php
			...
			<div><a href="admin.php" >
				<input id="submit_button" type="submit" value="Admin Page" class="btn btn-primary btn-block"></a></td>
			<td>	<a href="changelog.php" >
				<input id="submit_button" type="submit" value="Admin Changelog" class="btn btn-primary btn-block"></a></td>
			<td><a href="admin_news.php" >
				<input id="submit_button" type="submit" value="Admin Create News" class="btn btn-primary btn-block"></a></td>

			<td><a href="admin_gallery.php" >
				<input id="submit_button" type="submit" value="Admin Gallery" class="btn btn-primary btn-block"></a></td>

			<td><a href="admin_skills.php" >
			<input id="submit_button" type="submit" value="Admin Skills" class="btn btn-primary btn-block"></a></td>
			</tr>
			<tr>
			<td><a href="admin_reports.php" >
				<input id="submit_button" type="submit" value="Admin Reports" class="btn btn-primary btn-block"></a></td>
		
			<td><a href="helpdesk.php" >
				<input id="submit_button" type="submit" value="Admin Tickets" class="btn btn-primary btn-block"></a></td>
				

			<td><a href="admin_shop.php" >
				<input id="submit_button" type="submit" value="Admin Shop" class="btn btn-primary btn-block"></a></td>
		
			<td><a href="admin_auction.php" >
				<input id="submit_button" type="submit" value="Admin Auction" class="btn btn-primary btn-block"></a></td>
				<td><a href="forum.php?cat=4" >
				<input id="submit_button" type="submit" value="Feedback" class="btn btn-primary btn-block"></a></td>
				</tr>
				</table>
</center>
<?php
	...
	<div id="myaccount">
		...
		if ($char_array) {
			...
			<td><a href="createcharacter.php" ><input id="submit_button" type="submit" value="Create Character" class="btn btn-primary btn-block">
				</a>
